...
/*
EXCEPTional
Except allows us to obtain records on one table, but not the other
*/
...
/*
6 (ADDITIVE - ADD TO THE ORIGINAL LEFT TABLE) JOINS: INNER JOIN, SELF JOIN, LEFT JOIN, RIGHT JOIN, FULL JOIN, CROSS JOIN
*/

/*
Semi-joins and Anti-joins - choose records to keep in the left table
*/
...
-- Semi join chooses the records in the first table where a condition is met in the second table
-- Anti join chooses the records in the first table where a condition is NOT met in the second table
